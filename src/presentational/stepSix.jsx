...
class StepSix extends Component {
  ...
  playAnimation(event) {
    ...
    $('.pause-animation')
      .addClass('play-animation')
      .removeClass('pause-animation');
          ...
          <div className="container" id="server-animation">
            ...
            <div className="row">
                  ...
                  <div className="row">
                    <div className="vert-center">
                      <div className="col-md-8 text-center secondaryFont">
                        ...
                        <button
                          href="#"
                          className="restart hidden"
                          onClick={this.restartAnimation.bind(this)}
                        >
                          Restart Animation
                        </button>
              ...
              <div className="col-md-4 vert-center">
                <h1>
                  The server which creates the block, then sends it out to all
                  others on the network. So long as the majority recives and
                  validate the block, it is then successfully added to the
                  chain.
                </h1>
              </div>
            </div>
