            ...
            <div className="row">
              <div className="col-md-6 vert-center">
                <h1>
                  ...
                  transaction. So in this case, is <b className="secondaryFontInLine">{this.props.favFood}</b> REALLY your favourite food? Is there <b>proof</b> that it is your favourite food?
                </h1>
              </div>
                    ...
                    <div className="vert-center">
                      <div className="col-md-12 ">
                        <h3 className="secondaryFont">
                          <span className="blue-dark">IF</span>&nbsp;
                          (&nbsp;<span className=" purple">transmission</span>
